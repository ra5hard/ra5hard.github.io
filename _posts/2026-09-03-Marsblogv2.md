...
## ThakaRashard
### rashardmro
actually blog v3 alot of it all collapsed with the suspension of [RicoThaka](https://archive.org/details/screen-recording-2025-05-10-11.47.48-am) on @x f.k.a @twitter @nasa-jpl @foratlanta @la-county-isd if i have this data you have to see who using it in the schools @fbicyber 
